...
const schema = z.object({
  ...
  [SettingKey.HtmlImageInline]: z.boolean(),
  [SettingKey.HtmlMaxInlineSizeKb]: z.number().min(1).max(10240),
  [SettingKey.HtmlImageCompressEnabled]: z.boolean(),
  [SettingKey.HtmlImageCompressQuality]: z.number().min(0.1).max(1.0),
  [SettingKey.HtmlIncludeStyles]: z.boolean(),
  [SettingKey.HtmlPrintFriendly]: z.boolean(),
})
  ...
  <Card>
    ...
    <CardContent class="space-y-6">
      <form id="form-vee-general" class="w-2/3 space-y-6" @submit="onSubmit">
        ...
        <VeeField
          v-slot="{ field, errors }"
          :name="`[${SettingKey.HtmlImageInline}]`"
        >
          <Field orientation="horizontal" :data-invalid="!!errors.length">
            <FieldContent>
              <FieldLabel for="form-vee-general-html-image-inline">{{
                t('html.image_inline')
              }}</FieldLabel>
              <FieldError v-if="errors.length" :errors="errors" />
            </FieldContent>
            ...
            <Switch
              v-else
              id="form-vee-general-html-image-inline"
              :name="field.name"
              :model-value="field.value"
              :aria-invalid="!!errors.length"
              @update:model-value="field.onChange"
        ...
        <VeeField
          v-slot="{ field, errors }"
          :name="`[${SettingKey.HtmlMaxInlineSizeKb}]`"
        >
          <Field orientation="responsive" :data-invalid="!!errors.length">
            <FieldContent>
              <FieldLabel for="form-vee-general-html-max-inline-size">{{
                t('html.max_inline_size_kb')
              }}</FieldLabel>
              <FieldError v-if="errors.length" :errors="errors" />
            </FieldContent>
            <Skeleton v-if="query.isPending.value" class="h-9 w-40" />
            <Input
              v-else
              id="form-vee-general-html-max-inline-size"
              type="number"
              :name="field.name"
              :model-value="field.value"
              :aria-invalid="!!errors.length"
        ...
        <VeeField
          v-slot="{ field, errors }"
          :name="`[${SettingKey.HtmlImageCompressEnabled}]`"
        >
          <Field orientation="horizontal" :data-invalid="!!errors.length">
            <FieldContent>
              <FieldLabel for="form-vee-general-html-image-compress-enabled">{{
                t('html.image_compress_enabled')
              }}</FieldLabel>
              <FieldError v-if="errors.length" :errors="errors" />
            </FieldContent>
            <Skeleton v-if="query.isPending.value" class="h-9 w-40" />
            <Switch
              v-else
              id="form-vee-general-html-image-compress-enabled"
              :name="field.name"
              :model-value="field.value"
              :aria-invalid="!!errors.length"
              @update:model-value="field.onChange"
        ...
        <VeeField
          v-slot="{ field, errors }"
          :name="`[${SettingKey.HtmlImageCompressQuality}]`"
        >
          <Field orientation="responsive" :data-invalid="!!errors.length">
            <FieldContent>
              <FieldLabel for="form-vee-general-html-image-compress-quality">{{
                t('html.image_compress_quality')
              }}</FieldLabel>
              <FieldError v-if="errors.length" :errors="errors" />
            </FieldContent>
            <Skeleton v-if="query.isPending.value" class="h-9 w-40" />
            <Input
              v-else
              id="form-vee-general-html-image-compress-quality"
              type="number"
              step="0.1"
              min="0.1"
              max="1.0"
        ...
        <VeeField
          v-slot="{ field, errors }"
          :name="`[${SettingKey.HtmlIncludeStyles}]`"
        >
          <Field orientation="horizontal" :data-invalid="!!errors.length">
            <FieldContent>
              <FieldLabel for="form-vee-general-html-include-styles">{{
                t('html.include_styles')
              }}</FieldLabel>
              <FieldError v-if="errors.length" :errors="errors" />
            </FieldContent>
            <Skeleton v-if="query.isPending.value" class="h-9 w-40" />
            <Switch
              v-else
              id="form-vee-general-html-include-styles"
              :name="field.name"
              :model-value="field.value"
              :aria-invalid="!!errors.length"
              @update:model-value="field.onChange"
        ...
        <VeeField
          v-slot="{ field, errors }"
          :name="`[${SettingKey.HtmlPrintFriendly}]`"
        >
          <Field orientation="horizontal" :data-invalid="!!errors.length">
            <FieldContent>
              <FieldLabel for="form-vee-general-html-print-friendly">{{
                t('html.print_friendly')
              }}</FieldLabel>
              <FieldError v-if="errors.length" :errors="errors" />
            </FieldContent>
            <Skeleton v-if="query.isPending.value" class="h-9 w-40" />
            <Switch
              v-else
              id="form-vee-general-html-print-friendly"
              :name="field.name"
              :model-value="field.value"
              :aria-invalid="!!errors.length"
              @update:model-value="field.onChange"
